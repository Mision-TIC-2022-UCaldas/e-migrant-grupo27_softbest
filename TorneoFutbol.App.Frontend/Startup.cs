...
namespace TorneoFutbol.App.Frontend
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IRepositorioNovedades, RepositorioNovedades>();
            services.AddSingleton<IRepositorioEntidades, RepositorioEntidades>();
            services.AddSingleton<IRepositorioServicios, RepositorioServicios>();
